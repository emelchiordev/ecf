                ...
                <div className='justify-content-between'>
                    <div className="row">
                        <div className="input-group mb-3 col" error={errorValidation.firstName}>
                            <input type="text" className="form-control" name='firstName' onChange={handleChange} placeholder="Nom" aria-label="firstname" aria-describedby="firstname" />
                            {errorValidation.firstName && <p className='invalid-feedback d-block'>{errorValidation.firstName}</p>}
                        </div>

                        <div className="input-group mb-3 col">
                            <input type="text" className="form-control" name="lastName" onChange={handleChange} placeholder="Prénom" aria-label="lastname" aria-describedby="lastname" />
                            {errorValidation.lastName && <p className='invalid-feedback d-block'>{errorValidation.lastName}</p>}
                        </div>

                    </div>
                    <div className="mb-3">
                        <label for="formFileSm" className="form-label">Uploader une photo de profil</label>
                        <input class="form-control" type="file" id="formFile" />
                    </div>
                    <div className="input-group mb-3">
                        <textarea rows="5" className="form-control" name="description" onChange={handleChange} placeholder="Description" aria-label="description" aria-describedby="description" />
                    ...
                    <div className="input-group mb-3">
                        ...
                        <input type="email" className="form-control" name='email' onChange={handleChange} placeholder="Email" aria-label="email" aria-describedby="email" />
                    ...
                    <div className="input-group mb-3">
                        ...
                        <input type="password" className="form-control" name='password' onChange={handleChange} placeholder="Mot de passe" aria-label="password" aria-describedby="password" />
